...
Describe 'Module Tests' -Tag Unit {
    Context "Module Tests" {
        ...
        It 'root module PsBookmarkManager.psm1 should exist' {
            $PathToModule | Should -Exist
            $? | Should -BeTrue
        } #psm1Exists
        It 'manifest should contain PsBookmarkManager.psm1' {
            $PathToManifest |
            Should -FileContentMatchExactly "PsBookmarkManager.psm1"
        } #validPSM1
